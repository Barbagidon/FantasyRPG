...
> ⚠️ **ОТЛОЖЕНО (2026-07-30).** По итогам design-валидации персистентный мир в стиле Kingdom
> Come вырезан из первой версии игры целиком — несовместим с выбранной формой (линейная
> кампания, статичный хаб-лагерь, окна рассказчика вместо нодовых диалогов с NPC). См. таблицу
> «Вырезано» в `docs/roadmap.md`. Содержимое этого файла — не активная спецификация, а
> зафиксированная идея на случай, если проект вырастет в сиквел или крупное продолжение.
> Не читать как то, что нужно реализовывать сейчас.
