...
2. **Zero-GC & High FPS Optimization:**
   ...
   - Использование `readonly struct` для характеристик ([HeroStats.cs](file:///C:/Users/shtil/OneDrive/Desktop/FantasyRPG/Assets/Scripts/Core/Stats/HeroStats.cs)), избегая мусора в куче (Heap GC Spikes).
...
- 📊 [Модель Домена и Характеристики](file:///C:/Users/shtil/OneDrive/Desktop/FantasyRPG/docs/domain_model.md)
- 🔄 [Боевая Система и Машина Состояний](file:///C:/Users/shtil/OneDrive/Desktop/FantasyRPG/docs/combat_system.md)
- 🧝‍♂️ [Расы и Кооперативная Синергия](file:///C:/Users/shtil/OneDrive/Desktop/FantasyRPG/docs/races_and_synergies.md)
- 🗺️ [Дорожная Карта и Прогресс](file:///C:/Users/shtil/OneDrive/Desktop/FantasyRPG/docs/roadmap.md)
